...
The primary project of the MSU Software Engineering Lab is the grant-funded creation of
software that measures the quality of other software. Due to the needs of our funder, the current
version (v0.3.0) is designed to measure software written in the C# language.

## Table of Contents

1. [Introduction](#introduction)
   1. [What is QATCH?](#what-is-qatch)
   2. [How to use this data](#how-to-use-this-data)
...
QATCH, which is an acronym for Quality Analysis Tool Chain, is a framework for analyzing software quality.
